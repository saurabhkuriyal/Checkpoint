...
const MessDashboardPage = () => {
    const [isItsOpen, setIsItsOpen] = useState(true);
    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Top Actions: Add Mess & Staff Feedback Form */}
                <div className="flex justify-center mb-16">
                    <Link href="/mess/addMess" className="group relative overflow-hidden bg-white rounded-2xl p-6 shadow-md border border-gray-200 transition-all hover:shadow-xl hover:-translate-y-1 flex items-center gap-4 w-full max-w-sm cursor-pointer">
                    ...
                    <Link href="/mess/staffFeedbackForm" className="group relative overflow-hidden bg-white rounded-2xl p-6 shadow-md border border-gray-200 transition-all hover:shadow-xl hover:-translate-y-1 flex items-center gap-4 w-full max-w-sm cursor-pointer">
                        <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-600 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                            </svg>
                        </div>
                        <div className="text-left">
                            <h3 className="text-xl font-bold text-gray-900 group-hover:text-emerald-600 transition-colors">Staff QR Form</h3>
                            <p className="text-sm text-gray-500">Delhi Delight Staff Feedback</p>
                        </div>
                    </Link>
                </div>

                {/* ITS Greater Noida Section */}
                <div className="bg-white my-2 rounded-3xl p-8 shadow-lg border border-gray-100 relative overflow-hidden">
                    {/* Decorative Background Element */}
                    <div className="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-orange-50 rounded-full z-0 opacity-50"></div>

                    <div
                        onClick={() => setIsItsOpen(!isItsOpen)}
                        className={`relative z-10 flex items-center justify-between gap-4 cursor-pointer select-none ${isItsOpen ? 'mb-8 pb-6 border-b border-gray-100' : ''}`}
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900">ITS Greater Noida</h2>
                                <p className="text-gray-500">Active Mess Dashboard</p>
                            </div>
                        </div>

                        {/* Dropdown / Expand Toggle Button */}
                        <div className="p-3 bg-gray-100 hover:bg-orange-100 rounded-2xl text-gray-600 hover:text-orange-600 transition-colors">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                className={`h-6 w-6 transform transition-transform duration-300 ${isItsOpen ? 'rotate-180' : 'rotate-0'}`}
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                                strokeWidth={2}
                    ...
                    {isItsOpen && (
                        <div className="relative z-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
                            ...
                            {/* 3. Add Consumption */}
                            <Link href="/mess/addConsumption" className="group flex flex-col items-center p-6 bg-gray-50 rounded-2xl hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-amber-100">
                            ...
                            {/* 4. Report */}
                            <Link href="/mess/reports" className="group flex flex-col items-center p-6 bg-gray-50 rounded-2xl hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-purple-100">
                            ...
                            {/* 8. Staff Feedback */}
                            <Link href="/mess/staffFeedbackDashboard" className="group flex flex-col items-center p-6 bg-gray-50 rounded-2xl hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-emerald-100">
                                <div className="w-14 h-14 mb-4 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center group-hover:scale-110 group-hover:bg-emerald-500 group-hover:text-white transition-all duration-300 shadow-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                                    </svg>
                                </div>
                                <h3 className="font-semibold text-gray-800 text-center text-sm sm:text-base">Staff Feedback</h3>
                            </Link>

                        </div>
                    )}
                </div>
                {/* ITS Muradnagar Mess Section */}
                <div className="bg-white my-2 rounded-3xl p-8 shadow-lg border border-gray-100 relative overflow-hidden">
                    {/* Decorative Background Element */}
                    <div className="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-orange-50 rounded-full z-0 opacity-50"></div>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900">ITS Muradnagar</h2>
                                <p className="text-gray-500">Active Mess Dashboard</p>
                            </div>
                        </div>
                ...
                {/* IDST Mess Section */}
                <div className="bg-white my-2rounded-3xl p-8 shadow-lg border border-gray-100 relative overflow-hidden">
                    {/* Decorative Background Element */}
                    <div className="absolute top-0 right-0 -mt-10 -mr-10 w-40 h-40 bg-orange-50 rounded-full z-0 opacity-50"></div>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900">IDST</h2>
                                <p className="text-gray-500">Active Mess Dashboard</p>
                            </div>
                        </div>
                ...
                <div className="bg-white my-2 rounded-3xl p-8 shadow-lg border border-gray-100 relative overflow-hidden">
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900">NIIMS</h2>
                                <p className="text-gray-500">Active Mess Dashboard</p>
                            </div>
                        </div>
